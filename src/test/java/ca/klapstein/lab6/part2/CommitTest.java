...
class CommitTest {
    ...
    void random() {
        ...
        assertEquals(1, Commit.random(1, 1.0, 1.0).length);

        assertEquals(1, Commit.random(1, 1, 1).length);

        assertEquals(1, Commit.random(1, 100.0, 100.0).length);

        assertArrayEquals(new double[]{1.0}, Commit.random(1, 1.0, 1.0));
        assertArrayEquals(new double[]{0, 0, 0, 0, 0}, Commit.random(5, 0.0, 0.0));
    }

    @Test
    void randomValidateValues() {
        double[] randomDoubles = Commit.random(100000, -1000000000.000, 1000000000.000);
        for (double d : randomDoubles) {
            assertTrue(d >= -1000000000.000);
            assertTrue(d <= 1000000000.000);
        }

        double[] randomDoubles2 = Commit.random(100000, -10, 0);
    ...
    void max(Number expected, double[] input) {
        assertEquals(expected.doubleValue(), Commit.max(input));
    }
    ...
    void min(Number expected, double[] input) {
        assertEquals(expected.doubleValue(), Commit.min(input));
    }
    ...
    void normalize(double[] expected, double[] input) {
        assertArrayEquals(expected, Commit.normalize(input));
    }
    ...
    void sum(Number expected, double[] input) {
        assertEquals(expected.doubleValue(), Commit.sum(input));
    }
    ...
    void stddev(Number expected, double[] input) {
        assertEquals(expected.doubleValue(), Commit.stddev(input));
    }
    ...
    void stddevImprecise(Number expected, double[] input){
        assertEquals(expected.doubleValue(), Commit.stddev(input), 0.00000001);
    ...
    void arrayAdd(double[] expected, double[] input1, double[] input2) {
        assertArrayEquals(expected, Commit.arrayAdd(input1, input2));
    }
